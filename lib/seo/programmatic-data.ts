...
export const STYLE_SEO_DATA: StyleSEOData[] = [
  {
    ...
    metaDescription: 'Créez un intérieur moderne et épuré avec notre IA. Lignes nettes, couleurs neutres, matériaux contemporains. Visualisez votre pièce en style moderne en 30 secondes.',
  ...
  },
  {
    ...
    metaDescription: 'Adoptez le style scandinave et le hygge danois pour votre intérieur. Bois clair, lumière naturelle, confort. Visualisez le rendu par IA en 30 secondes.',
    hero: 'L\'art de vivre nordique : chaleur du bois, lumière naturelle et confort hygge au quotidien.',
    longDescription: 'Originaire des pays nordiques, le style scandinave mise sur la luminosité, le confort et la simplicité. Le bois clair est omniprésent, associé à des textiles douillets et des couleurs pastel. Le concept danois de "hygge" (le bien-être) en est l\'essence même.',
  ...
  },
  {
    ...
    metaDescription: 'Transformez votre pièce en loft industriel avec l\'IA. Briques apparentes, métal, béton. Obtenez un rendu professionnel en 30 secondes.',
  ...
  },
  {
    ...
    metaDescription: 'Créez un intérieur bohème et chaleureux avec l\'IA. Macramé, rotin, couleurs chaudes. Visualisez votre pièce en style boho en 30 secondes.',
  ...
  },
  {
    ...
    metaDescription: 'Adoptez le minimalisme pour votre intérieur avec l\'IA. Design épuré, fonctionnel et apaisant. Visualisez le rendu en 30 secondes.',
  ...
  },
  {
    ...
    metaDescription: 'Fusionnez le wabi-sabi japonais et le hygge scandinave dans votre intérieur. Style japandi par IA en 30 secondes. Résultat zen et élégant.',
  ...
  },
  {
    ...
    metaDescription: 'Adoptez les dernières tendances déco 2026 pour votre intérieur. Design contemporain, couleurs tendance, matériaux innovants. Rendu IA en 30 secondes.',
  ...
  },
  {
    ...
    metaDescription: 'Apportez l\'esprit vacances dans votre intérieur. Bleu, blanc, matières naturelles. Décoration coastal par IA en 30 secondes.',
  ...
  },
  {
    ...
    metaDescription: 'Créez un intérieur luxueux avec l\'IA. Marbre, laiton, velours, cristal. Visualisez votre pièce en version prestige en 30 secondes.',
...
export const ROOM_SEO_DATA: RoomSEOData[] = [
  {
    ...
    metaDescription: 'Redécorez votre salon avec l\'IA en 30 secondes. 12+ styles disponibles. Visualisez le rendu avant d\'acheter. Salon moderne, scandinave, bohème...',
  ...
  },
  {
    ...
    metaDescription: 'Transformez votre chambre en un espace de repos parfait avec l\'IA. Styles cosy, zen, luxe. Visualisez le résultat en 30 secondes.',
  ...
  },
  {
    ...
    metaDescription: 'Visualisez votre nouvelle cuisine avant de rénover. IA de décoration pour cuisine moderne, campagne chic ou contemporaine. Résultat en 30s.',
  ...
  },
  {
    ...
    metaDescription: 'Aménagez un bureau productif et esthétique avec l\'IA. Home office, bureau professionnel, espace de travail. Design par IA en 30 secondes.',
  ...
  },
  {
    ...
    metaDescription: 'Aménagez votre terrasse ou balcon avec l\'IA. Mobilier outdoor, plantes, éclairage. Visualisez votre futur espace extérieur en 30 secondes.',
  ...
  },
  {
    ...
    metaDescription: 'Redécorez votre salle à manger avec l\'IA. Table, chaises, luminaire : visualisez le résultat en 30 secondes. Styles modernes et classiques.',
