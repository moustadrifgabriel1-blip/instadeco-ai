  ...
  return (
    <div className="prestige-root prestige-body">
      ...
      <PrestigeEditorial
        ...
        image="https://tocgrsdlegabfkykhdrz.supabase.co/storage/v1/object/public/output-images/gemini/1787318782700-hv5awr.jpg"
        alt="Séjour mis en scène en style minimaliste par home staging virtuel IA"
      />
